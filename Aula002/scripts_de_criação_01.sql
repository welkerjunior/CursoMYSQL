...
-- Schema Aula001
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Aula001` DEFAULT CHARACTER SET utf8 ;
USE `Aula001` ;

-- -----------------------------------------------------
-- Table `Aula001`.`tipocliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Aula001`.`tipocliente` (
...
-- -----------------------------------------------------
-- Table `Aula001`.`cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Aula001`.`cliente` (
  ...
  CONSTRAINT `fk_cliente_tipocliente`
    ...
    REFERENCES `Aula001`.`tipocliente` (`i_tipocliente_tipocliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
